            ...
            <div class="row">
                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body checkout-form">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <input type="text" name="apartment" id="apartment" class="form-control" placeholder="Apartment, suite, unit, etc. (optional)" value="{{ (!empty($customerAddress->apartment)) ? $customerAddress->apartment : '' }}">
                                    </div>            
                                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card payment-form ">    
                        ...
                        <div>
                            <input checked type="radio" name="payment_method" value="cod" id="payment_method_one" class="payment_method">
                            <label for="payment_method_one" class="form-check-label">COD</label>
                        </div>

                        <div>
                            <input type="radio" name="payment_method" value="phonepe" id="payment_method_three" class="payment_method">
                            <label for="payment_method_three" class="form-check-label">Phone Pe</label>
                        </div>   

                        <div>
                            <input type="radio" name="payment_method" value="paypal" id="payment_method_four" class="payment_method">
                            <label for="payment_method_four" class="form-check-label">PayPal</label>
                        </div>   

                        <div>
                            <input type="radio" name="payment_method" value="paytm" id="payment_method_fift" class="payment_method">
                            <label for="payment_method_fift" class="form-check-label">Paytm</label>
                        </div>   

                        <div>
                            <input type="radio" name="payment_method" value="stripe" id="payment_method_two" class="payment_method">
                        ...
                        <div class="card-body p-0 d-none mt-3" id="card-payment-form">
                            ...
                            {{-- <div class='mb-3'>
                                <label class='control-label' for="expiry_month">Expiration Month</label> 
                                <input class='form-control card-expiry-month' name="expiry_month" id="expiry_month" placeholder='MM' size='2' type='text'>
                            </div>
                            <div class='mb-3'>
                                <label class='control-label' for="expiry_year">Expiration Year</label> 
                                <input class='form-control card-expiry-year' name="expiry_year" id="expiry_year" placeholder='YYYY' size='4' type='text'>
                            </div>                      --}}
                        </div>                           
                        ...
                        <div class="card-body p-0 d-none mt-3" id="card-payment-form">                            
                            <div class='mb-3 required'>
                                ...
                                <input class='form-control' type='text' name="card_name" id="card_name" placeholder="Name on Card">
                            </div>
                            <div class="mb-3 required">
                                <label for="card_number" class="mb-2">Card Number</label>
                                <input type="text" name="card_number" id="card_number" placeholder="Valid Card Number" class="form-control card-number">
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-6 required">
                                    <label for="expiry_month" class="mb-2">Expiry Month</label>
                                    <input type="text" name="expiry_month" id="expiry_month" placeholder="MM" class="form-control card-expiry-month">
                                </div>
                                <div class="col-md-6 required">
                                    <label for="expiry_year" class="mb-2">Expiry Year</label>
                                    <input type="text" name="expiry_year" id="expiry_year" placeholder="YYYY" class="form-control card-expiry-year">
                                </div>
                                <div class="col-md-6 required">
                                    <label for="card-cvc" class="mb-2">CVV Code</label>
                                    <input type="text" name="card-cvc" id="card-cvc" placeholder="123" class="form-control card-cvc">
                                </div>                                                    
                            </div> 
                            <div class='mb-3 error hide'>
...
@section('customJs')
    <script>
        ...
        $("#payment_method_four").click(function(){
            if ($(this).is(":checked") == true) {
                $("#card-payment-form").addClass('d-none');
            }
        });
        
        $("#payment_method_fift").click(function(){
            if ($(this).is(":checked") == true) {
                $("#card-payment-form").addClass('d-none');
            }
        });
