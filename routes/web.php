...
Route::any('/paymentresponsephonepe', [CartController::class, 'paymentResponsePhonePe'])->name('paymentresponsephonepe');
Route::any('/payment-status/{paymentId}',[CartController::class,'paymentStatus'])->name('front.paymentStatus');
...
Route::group(['prefix' => 'admin'], function(){
    ...
    Route::group(['middleware' => 'admin.auth'], function(){
        ...
        Route::delete('/ratings/{rating}',[ProductController::class,'productRatingsDestroy'])->name('products.productRatingsDelete');

        // Product Route product-subcategories.index
        Route::get('/product-subcategories',[ProductSubCategoryController::class,'index'])->name('product-subcategories.index');

        // Product Route product-images.update
        ...
        // Category Route temp-images.create 
