                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
                            ...
                            <div class="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                                <button onclick="removeProduct({{ $wishlist->product_id }})" href="javascript:void(0);" class="btn btn-outline-danger btn-sm" type="button"><i class="fas fa-trash-alt me-2"></i>Remove</button>
                            </div>
                        </div>  
                        @endforeach
                        @else
...
@section('customJs')
    <script>
        function removeProduct(id){
            if (confirm("Are you sure you want remove product from wishlist")) {
                $.ajax({
