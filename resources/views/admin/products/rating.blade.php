                            ...
                            <tbody>
                                @if ($ratings->isNotEmpty())
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($rating->status == 1)
                                            <a href="javascript:void(0);" onclick="changStatus(0, '{{ $rating->id }}');">
                                                <svg class="text-success-500 h-6 w-6 text-success" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                </svg>
                                            </a>
                                            @else
                                            <a href="javascript:void(0);" onclick="changStatus(1, '{{ $rating->id }}');">
...
<script>
      function deleteRating(id){
        ...
        var url = '{{ route("products.productRatingsDelete", "ID") }}';
    ...
    function changStatus(status, id){
        if (confirm("Are You Sure you want to chang Status")){
            $.ajax({
